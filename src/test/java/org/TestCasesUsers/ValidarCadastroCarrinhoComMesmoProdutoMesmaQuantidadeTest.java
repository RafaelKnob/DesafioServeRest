...
public class ValidarCadastroCarrinhoComMesmoProdutoMesmaQuantidadeTest {
    ...
    private String cadastrarNovoUsuario() {
        ...
        String requestBody = "{\n" +
                ...
                "  \"email\": \"mesmaquantidademesmoproduto100@qa.com\",\n" +
                "  \"password\": \"teste1\",\n" +
                "  \"administrador\": \"true\"\n" +
                "}";
    ...
    private String realizarLogin() {
        ...
        String email = "mesmaquantidademesmoproduto100@qa.com";
